...
export default function Arrow({ text, link, color }) {
  let styles =
    "w-fit flex items-center gap-[18px] bg-white text-[#333333] py-[20px] pl-[20.34px] pe-[49.47px]";

  let type = false;

  if (color == "black") {
    styles =
      "w-fit flex items-center gap-[18px] bg-[#333333] text-white py-[20px] pl-[20.34px] pe-[49.47px]";
    type = true;
  }
