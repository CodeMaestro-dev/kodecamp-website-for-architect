...
export default function Footer() {
  return (
    <div className="bg-[#333333] mt-[120px]">
      <div className="border-b-[1px] border-b-white flex flex-col lg:flex-row gap-0 md:gap-[99px] px-[20px] lg:px-[116px] py-[60px]">
        <Link to="/">
          <img src={logo_white} alt="home-page" />
        </Link>
        <div className="flex flex-col md:flex-row justify-between mt-[20px] md:mt-0 w-full gap-[40px] md:gap-0">
          <div>
